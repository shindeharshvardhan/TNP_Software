...
function StudentForm() {
  ...
  const handleMobile = (e, field) => {
    ...
    if (field === "smob") {
      ...
      if (value === pmob) {
        setMobError("Student mobile number and Parent mobile number should be different");
        isValid = false
      }
    }
    ...
    if (field === "pmob") {
      ...
      if (value === mob) {
        setPmobError("Student mobile number and Parent mobile number should be different");
        isValid = false
      }
    }
  };
  ...
  const handlehscscimarksobt = (e) => {
    ...
    if (value >= 0 && value <= hscscitotmarks) {
      ...
      setHSCscimarksobterror("Marks obtained must be between 0 and Total marks.");
      isValid = false
    }
  }
  ...
  const handlePgChange = (e, index, field) => {
    ...
    if (field === 'percentage') {
      if (value < 0 || value > 100) {
        ...
        setPgErrors((prevErrors) => ({ ...prevErrors, percentages: updatedErrors }));
      } else {
        const updatedErrors = [...pgErrors.percentages];
    ...
    if (field === 'attempts') {
      if (value < 1) {
        ...
        setPgErrors((prevErrors) => ({ ...prevErrors, attempts: updatedErrors }));
      } else {
        const updatedErrors = [...pgErrors.attempts];
        updatedErrors[index] = ''; // Clear error if valid
        setPgErrors((prevErrors) => ({ ...prevErrors, attempts: updatedErrors }));
  ...
  const generatePDF = async () => {
    ...
    if (photobase64) {
      doc.addImage(photobase64, 'JPEG', pageWidth - marginRight - photoWidth, yOffset, photoWidth, photoHeight);
    }
    ...
    addNormalText(`Permanent Address: ${pstreet}, ${pcity}, ${pstate}, ${ppostalcode}`);
    addNormalText(`Current Address: ${cstreet}, ${ccity}, ${cstate}, ${cpostalcode}`);
    ...
    const { department: pgDepartment, collegeName: pgCollegeName, numberOfATKT: pgNumberOfATKT, semesters: pgSemesters } = pgData;
    ...
    const termsArrayBuffer = await fetch(termsPdf).then(res => res.arrayBuffer());
    const termsPdfDoc = await PDFDocument.load(termsArrayBuffer);
    const termsPages = await mergedPdf.copyPages(termsPdfDoc, termsPdfDoc.getPageIndices());
      ...
      if (confirmation) {
        ...
        if (educationLevel === 'UG' || educationLevel === 'PG') {
          ...
          ugData.semesters.forEach((semester, index) => {
            ...
            formData.append(`ug_sem${index + 1}_percentage`, semester.percentage);
            formData.append(`ug_sem${index + 1}_attempts`, semester.attempts);
            if (semester.marksheet) {
              formData.append(`ug_sem${index + 1}_marksheet`, semester.marksheet);
            }
          });
        }
        ...
        if (educationLevel === 'PG') {
          ...
          pgData.semesters.forEach((semester, index) => {
            ...
            formData.append(`pg_sem${index + 1}_percentage`, semester.percentage);
            formData.append(`pg_sem${index + 1}_attempts`, semester.attempts);
            if (semester.marksheet) {
              formData.append(`pg_sem${index + 1}_marksheet`, semester.marksheet);
            }
          });
        }
        ...
        try {
          ...
          alert("There was an issue registering the student. Please try again.");
        }
      }
    } else {
        ...
        <form action="" onSubmit={handleSubmit}>
          ...
          <div className='glassmorphism shadow-lg rounded-lg md:p-8'>
            ...
            <label className="form-control bg-transparent border-0 m-2">
              <div className="label">
                <span className="label-text text-xl">Name: <span className="text-red-700">*</span></span>
              </div>
              <div className='flex gap-4'>
            ...
            <div className='flex'>
              <label className="form-control bg-transparent border-0 m-2 md:w-1/2">
                <div className="label">
                  <span className="label-text text-xl">Email: <span className="text-red-700">*</span></span>
                </div>
                <div className='flex gap-4'>
                  <input type="email" placeholder="Enter Email Id" className="glassmorphism input input-info student-form-input-style" required value={email} onChange={handleEmail} name='email' />
                </div>
              ...
              <label className="form-control bg-transparent border-0 m-2 md:w-1/2">
                <div className="label">
                  <span className="label-text text-xl">Mobile Number: <span className="text-red-700">*</span></span>
                </div>
                <div className='flex gap-4'>
                  <input type="text" placeholder="Enter Mobile Number" className="glassmorphism input input-info student-form-input-style" required value={mob} onChange={(e) => handleMobile(e, "smob")} maxLength={10} name='mob' />
                </div>
            ...
            <div className='flex'>
              <label className="form-control bg-transparent border-0 m-2 md:w-1/2">
                <div className="label">
                  <span className="label-text text-xl">Parent Mobile Number: <span className="text-red-700">*</span></span>
                </div>
                <div className='flex gap-4'>
                  <input type="text" placeholder="Enter Parent Mobile Number" className="glassmorphism input input-info student-form-input-style" value={pmob} required onChange={(e) => handleMobile(e, "pmob")} maxLength={10} name='pmob' />
                </div>
              ...
              <label className="form-control bg-transparent border-0 m-2 md:w-1/2">
                <div className="label">
                  <span className="label-text text-xl">Date of Birth: <span className="text-red-700">*</span></span>
                </div>
                <div className='flex gap-4'>
                  <input type="date" placeholder="Enter Mobile Number" className="glassmorphism input input-info student-form-input-style" required value={dob} onChange={(e) => setdob(e.target.value)} name='dob' />
                </div>
              </label>
            </div>
            ...
            <div className='flex'>
              <label className="form-control bg-transparent border-0 m-2 md:w-1/2">
                <div className="label">
                  <span className="label-text text-xl">Gender: <span className="text-red-700">*</span></span>
                </div>
                <div className='flex gap-4'>
                  <select className="glassmorphism select select-info student-form-input-style" value={gender} onChange={(e) => setGender(e.target.value)} required name='gender'>
              ...
              <label className="form-control bg-transparent border-0 m-2 md:w-1/2">
                <div className="label">
                  <span className="label-text text-xl">Marital Status: <span className="text-red-700">*</span></span>
                </div>
                <div className='flex gap-4'>
                  <select className="glassmorphism select select-info student-form-input-style" required value={maritalstatus} onChange={(e) => setMaritalStatus(e.target.value)} name='maritalstatus'>
                    <option value="" disabled selected>Select</option>
            ...
            <div className='flex'>
              ...
              <label className="form-control bg-transparent border-0 m-2 md:w-1/2">
                <div className="label">
                  <span className="label-text text-xl">Nationality: <span className="text-red-700">*</span></span>
                </div>
                <div className='flex gap-4'>
                  <input type="text" placeholder="Enter Nationality" className="glassmorphism input input-info student-form-input-style" required value={nationality} onChange={(e) => setNationality(e.target.value)} name='nationality' />
                </div>
              </label>

              <label className="form-control bg-transparent border-0 m-2 md:w-1/2">
                <div className="label">
                  <span className="label-text text-xl">Blood Group: <span className="text-red-700">*</span></span>
                </div>
                <div className='flex gap-4'>
                  <select className="glassmorphism select select-info student-form-input-style" required value={bloodgroup} onChange={(e) => setBloodGroup(e.target.value)} name='bloodgroup'>
                    <option value="" disabled selected>Select</option>
            ...
            <div className='flex'>
              <label className="form-control bg-transparent border-0 m-2 md:w-1/2">
                <div className="label">
                  <span className="label-text text-xl">Height (cm): <span className="text-red-700">*</span></span>
                </div>
                <div className='flex gap-4'>
                  <input type="number" placeholder="Enter Height (cm)" className="glassmorphism input input-info student-form-input-style" required value={height} onChange={handleHeight} name='height' />
                </div>
              ...
              <label className="form-control bg-transparent border-0 m-2 md:w-1/2">
                <div className="label">
                  <span className="label-text text-xl">Weight (kg): <span className="text-red-700">*</span></span>
                </div>
                <div className='flex gap-4'>
                  <input type="number" placeholder="Enter Weight (kg)" className="glassmorphism input input-info student-form-input-style" required value={weight} onChange={handleWeight} name='weight' />
                </div>
                {weighterror && <p className="text-red-500">{weighterror}</p>}
              </label>
            </div>

            <h4 className='text-2xl font-bold mx-3 mt-3'>Permanent Address: <span className="text-red-700">*</span></h4>
            ...
            <div className='flex'>
              <label className="form-control bg-transparent border-0 m-2 md:w-1/2">
                ...
                <div className='flex gap-4'>
                  <input type="text" placeholder="Enter Street" className="glassmorphism input input-info student-form-input-style" required value={pstreet} onChange={(e) => setPstreet(e.target.value)} name='pstreet' />
                </div>
              </label>
              ...
              <label className="form-control bg-transparent border-0 m-2 md:w-1/2">
                ...
                <div className='flex gap-4'>
                  <input type="text" placeholder="Enter City" className="glassmorphism input input-info student-form-input-style" required value={pcity} onChange={(e) => setPcity(e.target.value)} name='pcity' />
                </div>
              </label>
            </div>
            ...
            <div className='flex'>
              <label className="form-control bg-transparent border-0 m-2 md:w-1/2">
                ...
                <div className='flex gap-4'>
                  <input type="text" placeholder="Enter State" className="glassmorphism input input-info student-form-input-style" required value={pstate} onChange={(e) => setPstate(e.target.value)} name='pstate' />
                </div>
              </label>
              ...
              <label className="form-control bg-transparent border-0 m-2 md:w-1/2">
                ...
                <div className='flex gap-4'>
                  <input type="number" placeholder="Enter Postal Code" className="glassmorphism input input-info student-form-input-style" required value={ppostalcode} onChange={handlePostalCode} maxLength={6} name='ppostalcode' />
                </div>
                {ppostalcodeerror && <p className="text-red-500">{ppostalcodeerror}</p>}
              </label>
            </div>

            <input type="checkbox" name="Address_CheckBox" className='glassmorphism text-xl label-text m-2' onChange={handleCheckBox} checked={isSameAddress} />
            <label htmlFor="Address_Checkbox" className='label-text text-lg'>Current Address same as Permanent Address</label>

            <h4 className='text-2xl font-bold mx-3 mt-3'>Current Address: <span className="text-red-700">*</span></h4>
            ...
            <div className='flex'>
              <label className="form-control bg-transparent border-0 m-2 md:w-1/2">
                ...
                <div className='flex gap-4'>
                  <input type="text" placeholder="Enter Street" className="glassmorphism input input-info student-form-input-style" required value={cstreet} onChange={(e) => setCstreet(e.target.value)} disabled={isSameAddress} name='cstreet' />
                </div>
              </label>
              ...
              <label className="form-control bg-transparent border-0 m-2 md:w-1/2">
                ...
                <div className='flex gap-4'>
                  <input type="text" placeholder="Enter City" className="glassmorphism input input-info student-form-input-style" required value={ccity} onChange={(e) => setCcity(e.target.value)} disabled={isSameAddress} name='ccity' />
                </div>
              </label>
            </div>
            ...
            <div className='flex'>
              <label className="form-control bg-transparent border-0 m-2 md:w-1/2">
                ...
                <div className='flex gap-4'>
                  <input type="text" placeholder="Enter State" className="glassmorphism input input-info student-form-input-style" required value={cstate} onChange={(e) => setCstate(e.target.value)} disabled={isSameAddress} name='cstate' />
                </div>
              </label>
              ...
              <label className="form-control bg-transparent border-0 m-2 md:w-1/2">
                ...
                <div className='flex gap-4'>
                  <input type="number" placeholder="Enter Postal Code" className="glassmorphism input input-info student-form-input-style" required value={cpostalcode} onChange={handleCPostalCode} disabled={isSameAddress} name='cpostalcode' />
                </div>
                {cpostalcodeerror && <p className="text-red-500">{cpostalcodeerror}</p>}
              </label>
            </div>

            <h4 className='text-2xl font-bold mx-3 mt-3'>SSC Details: <span className="text-red-700">*</span></h4>
            ...
            <div className='flex'>
              <label className="form-control bg-transparent border-0 m-2 md:w-1/2">
                ...
                <div className='flex gap-4'>
                  <input type="number" placeholder="Passing Year" className="glassmorphism input input-info student-form-input-style" required value={sscpassingyear} onChange={handleSSCPassingYear} name='sscpassingyear' />
                </div>
              ...
              <label className="form-control bg-transparent border-0 m-2 md:w-1/2">
                ...
                <div className='flex gap-4'>
                  <input type="text" placeholder="Enter School Name" className="glassmorphism input input-info student-form-input-style" required value={sscschoolname} onChange={(e) => setSSCschoolname(e.target.value)} name='sscschoolname' />
                </div>
              </label>
            </div>
            ...
            <div className='flex'>
              <label className="form-control bg-transparent border-0 m-2 md:w-1/2">
                ...
                <div className='flex gap-4'>
                  <input type="number" placeholder="Enter Total Marks" className="glassmorphism input input-info student-form-input-style" required value={ssctotmarks} onChange={handleSSCtotmarks} name='ssctotmarks' />
                </div>
                {ssctotmarkserror && <p className="text-red-500">{ssctotmarkserror}</p>}
              </label>
              ...
              <label className="form-control bg-transparent border-0 m-2 md:w-1/2">
                ...
                <div className='flex gap-4'>
                  <input type="number" placeholder="Enter Marks Obtained" className="glassmorphism input input-info student-form-input-style" required value={sscmarksobt} onChange={handleSSCmarksobt} name='sscmarksobt' />
                </div>
                {sscmarksobterror && <p className="text-red-500">{sscmarksobterror}</p>}
              </label>
            </div>
            ...
            <div className='flex'>
              <label className="form-control bg-transparent border-0 m-2 md:w-1/2">
                ...
                <div className='flex gap-4'>
                  <input type="number" placeholder="Enter Percentage" className="glassmorphism input input-info student-form-input-style" required disabled value={sscper} name='sscper' />
                </div>
              </label>
              ...
              <label className="form-control bg-transparent border-0 m-2 md:w-1/2">
                ...
                <div className='flex gap-4'>
                  <input type="text" placeholder="Enter Board Name" className="glassmorphism input input-info student-form-input-style" required value={sscboardname} onChange={(e) => setSSCboardname(e.target.value)} name='sscboardname' />
                </div>
              </label>
            </div>
            ...
            <label className="form-control bg-transparent border-0 m-2 md:w-1/2">
              ...
              <div className='flex gap-4'>
                <input type="file" className="glassmorphism input input-info student-form-input-style pt-2" onChange={(e) => setSSCmarksheet(e.target.files[0])} required accept='.pdf' name='ssc_marksheet' />
              </div>
            </label>

            <h4 className='text-2xl font-bold mx-3 mt-4'>HSC or Diploma Details: <span className="text-red-700">*</span></h4>

            <label className="form-control bg-transparent border-0 m-2 md:w-1/2">
              <div className='flex gap-4'>
                <select className="glassmorphism select select-info student-form-input-style" onChange={handleHscOrDiplomaChange} value={hscOrDiploma} required name='hscOrDiploma'>
                  <option value="" disabled selected>Select</option>
              ...
              <div id='hsc'>
                ...
                <div className='flex'>
                  <label className="form-control bg-transparent border-0 m-2 md:w-1/2">
                    ...
                    <div className='flex gap-4'>
                      <input type="number" placeholder="Passing Year" className="glassmorphism input input-info student-form-input-style" required value={hscpassingyear} onChange={handleHSCpy} name='hscpassingyear' />
                    </div>
                  ...
                  <label className="form-control bg-transparent border-0 m-2 md:w-1/2">
                    ...
                    <div className='flex gap-4'>
                      <input type="text" placeholder="School Name" className="glassmorphism input input-info student-form-input-style" required value={hscschoolname} onChange={(e) => setHSCschoolname(e.target.value)} name='hscschoolname' />
                    </div>
                  </label>
                </div>
                ...
                <div className='flex'>
                  ...
                  <label className="form-control bg-transparent border-0 m-2 md:w-1/2">
                    ...
                    <div className='flex gap-4'>
                      <input type="number" placeholder="Total Marks" className="glassmorphism input input-info student-form-input-style" required value={hsctotmarks} onChange={handleHSCtotmarks} name='hsctotmarks' />
                    </div>
                    {hsctotmarkserror && <p className="text-red-500">{hsctotmarkserror}</p>}
                  </label>
                  ...
                  <label className="form-control bg-transparent border-0 m-2 md:w-1/2">
                    ...
                    <div className='flex gap-4'>
                      <input type="number" placeholder="Marks Obtained" className="glassmorphism input input-info student-form-input-style" required value={hscmarksobt} onChange={handleHSCmarksobt} name='hscmarksobt' />
                    </div>
                    {hscmarksobterror && <p className="text-red-500">{hscmarksobterror}</p>}
                  </label>
                </div>
                ...
                <div className='flex'>
                  ...
                  <label className="form-control bg-transparent border-0 m-2 md:w-1/2">
                    ...
                    <div className='flex gap-4'>
                      <input type="number" placeholder="Percentage" className="glassmorphism input input-info student-form-input-style" disabled value={hscper} name='hscper' />
                    </div>
                  </label>
                  ...
                  <label className="form-control bg-transparent border-0 m-2 md:w-1/2">
                    ...
                    <div className='flex gap-4'>
                      <select className="select select-info student-form-input-style" required value={hscstream} onChange={(e) => setHSCstream(e.target.value)} name='hscstream'>
                        <option value="" disabled selected>Select</option>
                ...
                <div className='flex'>
                  <label className="form-control bg-transparent border-0 m-2 md:w-1/2">
                    <div className="label">
                      <span className="label-text text-xl">Science Total Marks:</span>
                    </div>
                    <div className='flex gap-4'>
                      <input type="number" placeholder="Science Total Marks" className="glassmorphism input input-info student-form-input-style" required value={hscscitotmarks} onChange={handlehscscitotmarks} name='hscscitotmarks' />
                    </div>
                    {hscscitotmarkserror && <p className="text-red-500">{hscscitotmarkserror}</p>}
                  </label>

                  <label className="form-control bg-transparent border-0 m-2 md:w-1/2">
                    <div className="label">
                      <span className="label-text text-xl">Science Marks Obtained:</span>
                    </div>
                    <div className='flex gap-4'>
                      <input type="number" placeholder="Marks Obtained" className="glassmorphism input input-info student-form-input-style" required value={hscscimarksobt} onChange={handlehscscimarksobt} name='hscscimarksobt' />
                    </div>
                    {hscscimarksobterror && <p className="text-red-500">{hscscimarksobterror}</p>}
                  </label>
                </div>

                <label className="form-control bg-transparent border-0 m-2 md:w-1/2">
                  <div className="label">
                    <span className="label-text text-xl">Science Percentage:</span>
                  </div>
                  <div className='flex gap-4'>
                    <input type="number" placeholder="Science Percentage" className="glassmorphism input input-info student-form-input-style" disabled value={hscsciper} name='hscsciper' />
                  </div>
                </label>
                ...
                <div className='flex'>
                  <label className="form-control bg-transparent border-0 m-2 md:w-1/2">
                    ...
                    <div className='flex gap-4'>
                      <input type="text" placeholder="Board Name" className="glassmorphism input input-info student-form-input-style" required value={hscboardname} onChange={(e) => setHSCboardname(e.target.value)} name='hscboardname' />
                    </div>
                  </label>
                  ...
                  <label className="form-control bg-transparent border-0 m-2 md:w-1/2">
                    ...
                    <div className='flex gap-4'>
                      <input type="file" className="glassmorphism input input-info student-form-input-style pt-2" required onChange={(e) => setHSCmarksheet(e.target.files[0])} accept='.pdf' name='hsc_marksheet' />
                    </div>
                  </label>
                </div>
              ...
              <div id='diploma'>
                ...
                <div className='flex'>
                  <label className="form-control bg-transparent border-0 m-2 md:w-1/2">
                    ...
                    <div className='flex gap-4'>
                      <input type="number" placeholder="Passing Year" className="glassmorphism input input-info student-form-input-style" required value={diplomapassingyear} onChange={handlediplomapy} name='diplomapassingyear' />
                    </div>
                    {diplomapyerror && <p className="text-red-500">{diplomapyerror}</p>}
                  </label>
                  ...
                  <label className="form-control bg-transparent border-0 m-2 md:w-1/2">
                    ...
                    <div className='flex gap-4'>
                      <input type="text" placeholder="College Name" className="glassmorphism input input-info student-form-input-style" required value={diplomaclgname} onChange={(e) => setDiplomaclgname(e.target.value)} name='diplomaclgname' />
                    </div>
                  </label>
                </div>
                ...
                <div className='flex'>
                  <label className="form-control bg-transparent border-0 m-2 md:w-1/2">
                    <div className="label">
                      <span className="label-text text-xl">Diploma Specialization:</span>
                    </div>
                    <div className='flex gap-4'>
                      <input type="text" placeholder="Stream/Diploma Specialization" className="glassmorphism input input-info student-form-input-style" required value={diplomaspec} onChange={(e) => setDiplomaspec(e.target.value)} name='diplomaspec' />
                    </div>
                  </label>
                  ...
                  <label className="form-control bg-transparent border-0 m-2 md:w-1/2">
                    ...
                    <div className='flex gap-4'>
                      <input type="number" placeholder="Diploma CGPA" className="glassmorphism input input-info student-form-input-style" required value={diplomacgpa} onChange={handlediplomacgpa} name='diplomacgpa' />
                    </div>
                    {diplomacgpaerror && <p className="text-red-500">{diplomacgpaerror}</p>}
                  </label>
                </div>
                ...
                <div className='flex'>
                  <label className="form-control bg-transparent border-0 m-2 md:w-1/2">
                    <div className="label">
                      <span className="label-text text-xl">Diploma Percentage:</span>
                    </div>
                    <div className='flex gap-4'>
                      <input type="number" placeholder="Diploma Percentage" className="glassmorphism input input-info student-form-input-style" required value={diplomaper} onChange={handlediplomaper} name='diplomaper' />
                    </div>
                    {diplomapererror && <p className="text-red-500">{diplomapererror}</p>}
                  </label>

                  <label className="form-control bg-transparent border-0 m-2 md:w-1/2">
                    <div className="label">
                      <span className="label-text text-xl">Diploma Marksheet:</span>
                    </div>
                    <div className='flex gap-4'>
                      <input type="file" placeholder="Board Name" className="glassmorphism input input-info student-form-input-style pt-2" required onChange={(e) => setDiplomamarksheet(e.target.files[0])} accept='.pdf' name='diploma_marksheet' />
                    </div>
                  </label>
                </div>
              </div>
            ...
            <h4 className='text-2xl font-bold mx-3 mt-4'>UG or PG: <span className="text-red-700">*</span></h4>
              ...
              <div id='ug'>
                ...
                <div className='flex'>
                  <label className="form-control bg-transparent border-0 m-2 md:w-1/2">
                    ...
                    <div className='flex'>
                      <select className="glassmorphism select select-info student-form-input-style" onChange={handleDepartmentChange} required name='ugDepartment' value={ugData.department}>
                        <option value="" disabled selected>Select</option>
                        ...
                        <option value="BSC Applied Physics">BSC Applied Physics</option>
                        <option value="B.Arch">B.Arch</option>
                        <option value="BE Chemical Engineering">BE Chemical Engineering</option>
                        <option value="BE Civil Engineering">BE Civil Engineering</option>
                        <option value="BE Computer Science and Engineering">BE Computer Science and Engineering</option>
                        <option value="BE Electrical Engineering">BE Electrical Engineering</option>
                        <option value="BE Electronics Engineering">BE Electronics Engineering</option>
                        <option value="BE Mechanical Engineering">BE Mechanical Engineering</option>
                        <option value="BE Metallurgical and Materials Engineering">BE Metallurgical and Materials Engineering</option>
                        <option value="BE Textile Engineering">BE Textile Engineering</option>
                        <option value="Water Resources Engineering and Management(WREM)">Water Resources Engineering and Management (WREM)</option>
                      </select>
                    </div>
                  </label>
                  ...
                  <label className="form-control bg-transparent border-0 m-2 md:w-1/2">
                    ...
                    <div className='flex gap-4'>
                      <input type="text" placeholder="College Name" className="glassmorphism input input-info student-form-input-style" required onChange={(e) => setUgData({ ...ugData, collegeName: e.target.value })} name='ugCollegeName' value={ugData.collegeName} />
                    </div>
                  </label>
                </div>
                ...
                <div className='flex'>
                  <label className="form-control bg-transparent border-0 m-2 md:w-1/2">
                    <div className="label">
                      <span className="label-text text-xl">Number of ATKT:</span>
                    </div>
                    <div className='flex gap-4'>
                      <input
                        type="number"
                        placeholder="Number of ATKT (0-2)"
                        max={2} value={ugData.numberOfATKT}
                        className="glassmorphism input input-info student-form-input-style"
                ...
                {ugData.semesters.map((sem, index) => (
                  <div key={index} className='glassmorphism m-4 p-4'>
                    <div className="flex">
                      <label className="form-control bg-transparent border-0 m-2 md:w-1/2">
                        <span className="label-text text-xl">Sem-{index + 1} Year:</span>
                        <input
                          type="month"
                          className="glassmorphism input input-info student-form-input-style"
                      ...
                      <label className="form-control bg-transparent border-0 m-2 md:w-1/2">
                        <span className="label-text text-xl">Sem-{index + 1} Percentage:</span>
                        <input
                          type="text"
                          placeholder="Percentage"
                          className="glassmorphism input input-info student-form-input-style"
                          onChange={(e) => handleUgChange(e, index, 'percentage')}
                          value={sem.percentage}
                          name={`ug_sem${index + 1}_percentage`}
                        />
                        {ugerrors.percentages[index] && (
                          <p className="text-red-500">{ugerrors.percentages[index]}</p>
                        )}
                      </label>
                      </div>
                    ...
                    <div className="flex">
                      <label className="form-control bg-transparent border-0 m-2 md:w-1/2">
                        ...
                        {ugerrors.attempts[index] && (
                          <p className="text-red-500">{ugerrors.attempts[index]}</p>
                        )}
                      </label>

                      <label className="form-control bg-transparent border-0 m-2 md:w-1/2">
                        <span className="label-text text-xl">Sem-{index + 1} Marksheet:</span>
                        <input
                          type="file"
                          accept=".pdf"
                          className="glassmorphism input input-info student-form-input-style pt-2"
              ...
              <div id='pg'>
                ...
                <div className='flex'>
                    ...
                    <label className="form-control bg-transparent border-0 p-0">
                      <div className='flex'>
                        ...
                        >
                          ...
                          <option value="MSC applied Maths">MSC applied Maths</option>
                          <option value="MSC applied Chemistry">MSC applied Chemistry</option>
                          <option value="MSC applied Physics">MSC applied Physics</option>
                          <option value="MSC Industrial Mathematics">MSC Industrial Mathematics</option>
                          <option value="MSC Financial Mathematics">MSC Financial Mathematics</option>
                          <option value="Master of Computer Applications">Master of Computer Applications</option>
                          <option value="ME Civil Environmental Engineering">ME Civil Environmental Engineering</option>
                          <option value="ME Civil Fracture Mechanics">ME Civil Fracture Mechanics</option>
                          <option value="ME Civil Geotechnical Engineering">ME Civil Geotechnical Engineering</option>
                          <option value="ME Civil Highway and Transportation Engineering">ME Civil Highway and Transportation Engineering</option>
                          <option value="ME Civil Integrated Water Management">ME Civil Integrated Water Management</option>
                          <option value="ME Civil Structural Engineering">ME Civil Structural Engineering</option>
                          <option value="ME Civil Water Resources Engineering">ME Civil Water Resources Engineering</option>
                          <option value="ME Electrical Automatic Control and Robotics">ME Electrical Automatic Control and Robotics</option>
                          <option value="ME Electrical Power Engineering">ME Electrical Power Engineering</option>
                          <option value="ME Electrical Industrial Engineering">ME Electrical Industrial Engineering</option>
                          <option value="ME Electrical Microprocessor System Application">ME Electrical Microprocessor System Application</option>
                          <option value="ME Mechanical Jet Propulsion and Gas Turbine Plant">ME Mechanical Jet Propulsion and Gas Turbine Plant</option>
                          <option value="ME Mechanical Production Engineering">ME Mechanical Production Engineering</option>
                          <option value="ME Mechanical Thermal Science">ME Mechanical Thermal Science</option>
                          <option value="ME Metallurgy Industrial Metallurgy">ME Metallurgy Industrial Metallurgy</option>
                          <option value="ME Metallurgy Material Science and Engineering">ME Metallurgy Material Science and Engineering</option>
                          <option value="ME Metallurgy Welding Technology">ME Metallurgy Welding Technology</option>
                          <option value="ME Textile Engineering">ME Textile Engineering</option>
                          <option value="ME Textile Man Made Textile">ME Textile Man Made Textile</option>
                          <option value="ME Textile Processing">ME Textile Processing</option>
                          <option value="Master of Urban and Regional Planning">Master of Urban and Regional Planning</option>
                        </select>
                      </div>
                    </label>
                  </label>
                  ...
                  <label className="form-control bg-transparent border-0 m-2 md:w-1/2">
                    ...
                    <div className='flex gap-4'>
                      <input type="text" placeholder="College Name" className="glassmorphism input input-info student-form-input-style" value={pgData.collegeName} onChange={(e) => setPgData({ ...pgData, collegeName: e.target.value })} required name='pgCollegeName' />
                    </div>
                  </label>
                </div>
                ...
                <div className='flex'>
                  <label className="form-control bg-transparent border-0 m-2 md:w-1/2">
                    ...
                    <div className='flex gap-4'>
                      <input type="number" placeholder="Number of ATKT" className="glassmorphism input input-info student-form-input-style" min={0} max={2} value={pgData.atkt} onChange={handlePgAtktChange} required name='pgATKT' />
                    </div>
                    {pgErrors.atkt && <p className="text-red-500">{pgErrors.atkt}</p>}
                  </label>
                </div>
                <br />
                  ...
                  <div className='glassmorphism m-4 p-4'>
                    <div key={index}>
                      <div className='flex'>
                        <label className="form-control bg-transparent border-0 m-2 md:w-1/2">
                          <div className="label">
                            <span className="label-text text-xl">Sem-{index + 1} Passing Year:</span>
                          </div>
                          <div className='flex gap-4'>
                            <input
                              type="month"
                        ...
                        <label className="form-control bg-transparent border-0 m-2 md:w-1/2">
                          ...
                          <div className='flex gap-4'>
                            <input
                              ...
                              className="glassmorphism input input-info student-form-input-style"
                              value={sem.percentage}
                              onChange={(e) => handlePgChange(e, index, 'percentage')}
                              name={`pg_sem${index + 1}_percentage`}
                            />
                          </div>
                          {pgErrors.percentages[index] && (
                            <p className="text-red-500">{pgErrors.percentages[index]}</p>
                          )}
                        </label>
                      </div>
                      ...
                      <div className='flex'>
                        <label className="form-control bg-transparent border-0 m-2 md:w-1/2">
                          <div className="label">
                            <span className="label-text text-xl">Number of attempts:</span>
                          </div>
                          <div className='flex gap-4'>
                            <input
                              type="number"
                              ...
                              className="glassmorphism input input-info student-form-input-style"
                              value={sem.attempts}
                              onChange={(e) => handlePgChange(e, index, 'attempts')}
                              name={`pg_sem${index + 1}_attempts`}
                            />
                          </div>
                          {pgErrors.attempts[index] && (
                            <p className="text-red-500">{pgErrors.attempts[index]}</p>
                          )}
                        </label>
            ...
            <div className='flex'>
              <label className="form-control bg-transparent border-0 m-2 md:w-1/2">
                <div className="label">
                  <span className="label-text text-xl">Password: <span className="text-red-700">*</span></span>
                </div>
                <div className='flex gap-4'>
                  <input type="password" placeholder="Enter Password" className="glassmorphism input input-info student-form-input-style" required value={password} onChange={handlePassword} name='password' />
                </div>
              ...
              <label className="form-control bg-transparent border-0 m-2 md:w-1/2">
                <div className="label">
                  <span className="label-text text-xl">Confirm Password: <span className="text-red-700">*</span></span>
                </div>
                <div className='flex gap-4'>
                  <input type="password" placeholder="Confirm Password" className="glassmorphism input input-info student-form-input-style" required value={cpassword} onChange={handleCPassword} name='confirm-password' />
                </div>
            ...
            <div className="form-control my-4">
              <label className="cursor-pointer flex gap-2 items-center">
                <input type="checkbox" className="glassmorphism checkbox my-3" checked={isAgreed} onChange={handleAgreement} />
                <span className="label-text">
                  I agree to the <a href="/TNP Terms.pdf" target="_blank" className="text-blue-600 underline">terms and conditions</a>.
                </span>
              </label>
            </div>
